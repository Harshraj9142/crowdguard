                 ...
                 {MOCK_INCIDENTS.map((inc) => (
                    <div key={inc.id} className="p-4 border-b last:border-0 hover:bg-muted/50 transition-colors cursor-pointer">
                       ...
                       <div className="flex items-center gap-2 mt-2 text-xs text-muted-foreground">
                          <CheckCircle size={12} className="text-eco-500" />
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const newIncident: Incident = {
        ...
        latitude: 40.7128,
        longitude: -74.0060,
        description: 'New incident reported via web.',
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                 ...
                 <div className="flex gap-2">
                    <Input placeholder="Detecting location..." defaultValue="40.7128, -74.0060" readOnly />
              ...
              <div className="space-y-2">
                 ...
                 <textarea className="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm" placeholder="Describe what you saw..." required />
              </div>
